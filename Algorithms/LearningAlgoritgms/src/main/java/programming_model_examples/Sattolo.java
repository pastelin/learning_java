package programming_model_examples;
/******************************************************************************
 *  Compilation:  javac programming_model_examples.Sattolo.java
 *  Execution:    java programming_model_examples.Sattolo < list.txt
 ...
 *  using programming_model_examples.Sattolo's algorithm under the assumption that Math.random()
 *  generates independent and uniformly distributed numbers between
 *  0 and 1.
 *
 *  %  echo 0 1 2 3 4 | java programming_model_examples.Sattolo
 *  1
 *  2
 *  4
 *  0
...
/**
 *  The {@code programming_model_examples.Sattolo} class provides a client for reading a sequence
 *  of <em>n</em> strings and computing a <em>unifomly random cycle</em>
 *  of length <em>n</em> using programming_model_examples.Sattolo's algorithm.
